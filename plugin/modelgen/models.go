...
import (
	...
	"github.com/siongleng89/gqlgen/codegen/templates"
...
func (m *Plugin) MutateConfig(cfg *config.Config) error {
	...
	for _, it := range b.Scalars {
		cfg.Models.Add(it, "github.com/siongleng89/gqlgen/graphql.String")
	}
	...
	for _, field := range schemaType.Fields {
		...
		if f.Omittable {
			...
			if omittableType == nil {
				omittableType, err = binder.FindTypeFromName("github.com/siongleng89/gqlgen/graphql.Omittable")
				if err != nil {
					return nil, err
				}
			}
...
func findAndHandleCyclicalRelationships(b *ModelBuild) {
	for ii, structA := range b.Models {
		for _, fieldA := range structA.Fields {
			...
			// the field Type string will be in the form "github.com/siongleng89/gqlgen/codegen/testserver/followschema.LoopA"
