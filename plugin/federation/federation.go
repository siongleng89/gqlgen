...
import (
	...
	"github.com/siongleng89/gqlgen/plugin/federation/fieldset"
)
	...
	builtins := config.TypeMap{
		"_Service": {
			Model: config.StringList{
				"github.com/siongleng89/gqlgen/plugin/federation/fedruntime.Service",
			},
		},
		"_Entity": {
			Model: config.StringList{
				"github.com/siongleng89/gqlgen/plugin/federation/fedruntime.Entity",
			},
		},
		"Entity": {
			Model: config.StringList{
		...
		"_Any": {
			Model: config.StringList{"github.com/siongleng89/gqlgen/graphql.Map"},
		},
	}
