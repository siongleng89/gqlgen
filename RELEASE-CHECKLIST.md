...
1. Run the https://github.com/siongleng89/gqlgen/blob/master/bin/release:
```
...
5. Go to https://github.com/siongleng89/gqlgen/releases and draft new release, autogenerate the release notes, and Create a discussion for this release
